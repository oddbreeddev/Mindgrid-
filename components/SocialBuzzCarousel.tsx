      ...
      <div className="flex gap-4 overflow-x-auto pb-6 pt-2 no-scrollbar snap-x scroll-smooth">
        {buzz.map((item, idx) => {
          ...
          return (
            <div 
              key={idx} 
              className="min-w-[300px] md:min-w-[350px] bg-white rounded-[2rem] border border-slate-100 shadow-sm p-6 snap-center hover:shadow-xl transition-all hover:-translate-y-1 group/card"
            >
